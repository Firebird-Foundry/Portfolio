...
<div id="navBar" class="shadow-md bg-senary flex h-[6vh]">
...
<div id="footer" class="shadow-md bg-senary flex h-[5vh]">
	<div class="flex w-10/12 pl-32">
		<p class="my-auto text-tertiary">
